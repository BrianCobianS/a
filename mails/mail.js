...
const datos= {  
    ...
    paquetes: 'Morty',
    version: 'accept',
    nivel: 'brian.cobian@alumnos.udg.mx',
    email: '12712/12',
    pass: 'm1',
    usr: 'master',
    ip: '12.12.12',
...
const Enviarmail= async (datos)=>{
																		...
																		<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																			<tr>
																				<td class="pad" style="width:100%;text-align:center;padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
																					<h1 style="margin: 0; color: #ffffff; font-size: 23px; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Hello ${email}! </span></h1>
																				</td>
																			</tr>
																		</table>
																	</td>
													...
													<tr>
														<td class="column column-1" width="66.66666666666667%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
															<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																<tr>
																	<td class="pad" style="width:100%;text-align:center;padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
																		<h1 style="margin: 0; color: #ffffff; font-size: 62px; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">Controller ${ip} recived</h1>
																	</td>
																</tr>
															</table>
															...
															<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																<tr>
																	<td class="pad" style="width:100%;text-align:center;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
																		<h1 style="margin: 0; color: #ffffff; font-size: 45px; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Installation information:</span></h1>
														...
														<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
															<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																<tr>
																	...
																	<div style="color:#d5d5d5;font-size:18px;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-weight:400;line-height:150%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:27px;">                                                                    
																			<ol>
																			<li >IP: 		<strong style="color: #ffffff;">${ip} </strong></li>
																			<li>User: 		<strong style="color: #ffffff;">${usr}</strong></li>
																			<li>Password: 	<strong style="color: #ffffff;">${pass}</strong> </li>
																			<li>Type of installation: <strong style="color: #ffffff;">${temp}</strong> </li>
																			<li>Version: <strong style="color: #ffffff;">${version}</strong> </li>
																			<li>Level: <strong style="color: #ffffff;">${nivel}</strong> </li>
																			<li>Packages: <strong style="color: #ffffff;">${paquetes}</strong></li>
																			<li>ASM: <strong style="color: #ffffff;">${ASM}</strong></li>
																			<li>Installation date: <strong style="color: #ffffff;">${fecha} </strong></li>
																			</ol>
																	</div>															</td>
																</tr>
															</table>
												...
												<tbody>
													<tr>
														<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
															<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																<tr>
																	<td class="pad" style="width:100%;text-align:center;padding-top:50px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
																		<h2 style="margin: 0; color: #ffffff; font-size: 30px; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">More information:</span></h2>
																	</td>
																</tr>
															</table>
																...
																<tr>
																	<td class="pad" style="padding-top:10px;padding-right:10px;padding-bottom:45px;padding-left:10px;">
																		<div style="color:#d5d5d5;font-size:18px;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-weight:400;line-height:150%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:27px;">
																			<p style="margin: 0;">The controller has been recived. You will receive an email with the result once the installation is finished</p>
																		</div>
																	</td>
																</tr>
															</table>
  ...
  attachments: [
	{   // file on disk as an attachment
		filename: `Log-${ip}.txt`,
		path: 'C:/Users/brian.cobian/Desktop/IMDesatendida/Fullstackpage/mails/log.txt' // stream this file
	}]
    })
