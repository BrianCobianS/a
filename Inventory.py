...
def controller(host,user,password):
    ...
    contenido = open("/home/ebossteam/UnattendedInstallation/FULLSTACK/Back-End/public/Inventories/template.txt").read().splitlines()
    ...
    f = open('/home/ebossteam/temp/'+IP+'/Inventories/import_inventory.yml', "w")
    f.writelines("\n".join(contenido))
    f.close
