...
EMAIL=(sys.argv[11])
print(IP,USR,PASS,OPC,COMP,LEV,ASM,FECHA,VERSION,PAQUETES,EMAIL)
...
contenido.insert(7,"rm -r /home/ebossteam/temp/"+IP)
print("rm -r /home/temp/"+IP)
contenido.insert(8,"python3 /home/ebossteam/UnattendedInstallation/FULLSTACK/mails/email.py "+IP+" "+USR+" "+PASS+" "+OPC+" "+LEV+" "+ASM+" "+FECHA+" "+VERSION+" "+PAQUETES+" "+EMAIL)
print("python3 /home/ebossteam/UnattendedInstallation/FULLSTACK/mails/email.py "+IP+" "+USR+" "+PASS+" "+OPC+" "+LEV+" "+ASM+" "+FECHA+" "+VERSION+" "+EMAIL+" "+PAQUETES)
