...
print(contenido)
contenido.insert(1,"mkdir /home/ebossteam/home/ebossteam/temp/"+IP)
print("mkdir /home/ebossteam/home/ebossteam/temp/"+IP)
contenido.insert(2,"cp -r /home/ebossteam/home/ebossteam/ansibletest/ansible/* /home/ebossteam/home/ebossteam/temp/"+IP)
print("cp -r /home/ebossteam/home/ebossteam/ansibletest/ansible/* /home/ebossteam/home/ebossteam/temp/"+IP)
...
contenido.insert(6,"ansible-playbook /home/temp/"+IP+"/ansible/playbooks/os4690/Install_Controller.yml -vv  -i /home/ebossteam/ansibletest/ansible/Inventories/import_inventory.yml -e 'level_complement="+COMP+" opc="+OPC+" ASM="+ASM+" level_name="+LEV+"' 2>&1 | tee /var/log/logscontroladores/"+IP+"-$(date +%Y%m%d_%H%M%S).txt")
print("ansible-playbook /home/temp/"+IP+"/ansible/playbooks/os4690/Install_Controller.yml -vv  -i /home/ebossteam/ansibletest/ansible/Inventories/import_inventory.yml -e 'level_complement="+COMP+" opc="+OPC+" ASM="+ASM+" level_name="+LEV+"' 2>&1 | tee /var/log/logscontroladores/"+IP+"-$(date +%Y%m%d_%H%M%S).txt")
